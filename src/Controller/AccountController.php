...
{
    /**
     * @Route("/cuenta/iniciar-sesion", name="account-login")
     *
    ...
    public function loginAction(
        ...
        return $this->render('gepyxis/account/login.html.twig', [
     ...
     *
     * @Route("/cuenta/registrarse", name="account-register")
     *
     * @param Request $request
    ...
    public function registerAction(
        ...
        return $this->render('gepyxis/account/register.html.twig', [
            'customer' => $customer,
            'form' => $form->createView(),
            'errors' => $errors,
            'hideBreadcrumbs' => true,
     ...
     *
     * @Route("/cuenta/perfil", name="account-index")
     * @Security("is_granted('ROLE_USER')")
     *
    ...
    /**
     * @Route("/cuenta/update-marketing", name="account-update-marketing-permission")
     * @Security("is_granted('ROLE_USER')")
     *
     * @param Request $request
     * @param Service $consentService
    ...
    /**
     * @Route("/cuenta/confirm-newsletter", name="account-confirm-newsletter")
     *
     * @param Request $request
     * @param NewsletterDoubleOptInService $newsletterDoubleOptInService
     * @param Translator $translator
    ...
    /**
     * @Route("/cuenta/recuperar-contrasena", name="account-password-send-recovery")
     *
     * @param Request $request
    ...
    /**
     * @Route("/cuenta/restablecer-contrasena", name="account-reset-password")
     *
     * @param Request $request
     * @param PasswordRecoveryService $service
     * @param Translator $translator
