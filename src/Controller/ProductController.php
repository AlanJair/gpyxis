...
use \Pimcore\Model\DataObject\Solucion;
...
class ProductController extends BaseController
{
    ...
    public function detailAction(
        ...
        if ($product instanceof Proyecto) {

            return $this->render('gepyxis/product/detail.html.twig', $paramBag);
        }

        if ($product instanceof Solucion) {
...
//            $productListing->addQueryCondition($term);
    ...
    public function productCellAction(Request $request)
    {
        ...
        if($type == 'object') {
            ...
            throw new \Exception("Este objeto no es compatible");
        }
    }
}
